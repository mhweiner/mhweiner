      ...
      <div className={styles.default} ref={this.ref}>
        <div className={styles.belt}>
          ...
          <div className={styles.text}>
            ...
            <p>As a kid, I spent much of my time programming and building custom model rockets and R/C airplanes. When I was in second grade, I found an old junk computer and learned how to write programs for it using a book from my elementary school's library. At age fifteen, I started my own company building web applications for local businesses and non-profits. I became passionate about UI design and HCI (Human Computer Interaction).</p>
            <p>After studying Aerospace Engineering and Computer Science at the University at Buffalo, I co-founded a mission-driven health-tech startup to improve transparency and consistency in patient care, leveraging my UI design and systems problem solving skills. NextEMR was the first UX-centric <a href="https://en.wikipedia.org/wiki/Electronic_health_record" target="_blank">EHR</a> application. I soon realized that there are safety-critical applications in healthcare, just like in aerospace. That company was acquired in 2009.</p>
            
            <p>Ever since, I've focused on ways to help improve HCI and reliability in software in other industries.</p>
